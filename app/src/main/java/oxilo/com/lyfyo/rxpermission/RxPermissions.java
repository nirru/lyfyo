package oxilo.com.lyfyo.rxpermission;
...
public class RxPermissions {
    ...
    public ObservableTransformer<Object, Boolean> ensure(final String... permissions) {
        return new ObservableTransformer<Object, Boolean>() {
            @Override
            public ObservableSource<Boolean> apply(@io.reactivex.annotations.NonNull Observable<Object> o) {
                return request(o, permissions)
                        // Transform Observable<Permission> to Observable<Boolean>
                        .buffer(permissions.length)
                        .flatMap(new Function<List<Permission>, Observable<Boolean>>() {
                            @Override
                            public Observable<Boolean> apply(@io.reactivex.annotations.NonNull List<Permission> permissions) throws Exception {
    ...
    public Observable<Boolean> request(final String... permissions) {
        return Observable.just(permissions).compose(ensure(permissions));
    }
    ...
    public Observable<Permission> requestEach(final String... permissions) {
        return Observable.just(permissions).compose(ensureEach(permissions));
    }
