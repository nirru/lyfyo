 ...
 */
public class OfferListAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public OfferListAdapter(int inflated_row, List<T> productLists, Context mContext) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
       ...
       ((EventViewHolder) holder).offer_name.setText(((String)dataItem).toString());
        }else{
    ...
    public static class EventViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        protected TextView offer_name;
        public EventViewHolder(View v) {
            super(v);
            offer_name = (TextView) v.findViewById(R.id.text);
        }
