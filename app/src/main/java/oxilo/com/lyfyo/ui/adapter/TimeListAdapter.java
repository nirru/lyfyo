 ...
 */
public class TimeListAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public TimeListAdapter(int inflated_row, List<T> productLists, Context mContext) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
       ...
       ((EventViewHolder) holder).sl_time.setText(((String)dataItem).toString());
    ...
    public static class EventViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        protected TextView sl_time;
        public EventViewHolder(View v) {
            super(v);
            sl_time = (TextView)v.findViewById(R.id.l1);
