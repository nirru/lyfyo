 ...
 */
public class PopularLocationListAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public PopularLocationListAdapter(int inflated_row, List<T> productLists, Context mContext) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
       ...
       ((EventViewHolder) holder).sl_area.setText(((PopularLocation)dataItem).getLName());
       ((EventViewHolder) holder).sl_count.setText( ((PopularLocation)dataItem).getSalonCount() +  " places ");
        }
    ...
    public static class EventViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        protected TextView sl_area,sl_count;
        public EventViewHolder(View v) {
            super(v);
            sl_area = (TextView)v.findViewById(R.id.l1);
            sl_count = (TextView)v.findViewById(R.id.p1);
