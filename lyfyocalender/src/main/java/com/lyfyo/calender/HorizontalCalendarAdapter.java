...
class HorizontalCalendarAdapter extends RecyclerView.Adapter<HorizontalCalendarAdapter.DayViewHolder> {
    ...
    public void onBindViewHolder(DayViewHolder holder, int position) {
        ...
        if (position == selectedItemPosition) {
            ...
            holder.txtDayNumber.setBackground(horizontalCalendar.getSelectedTextBackground());
        ...
        // Unselected Days
            ...
            holder.txtDayName.setTextColor(horizontalCalendar.getTextColorNormal());
            holder.txtDayNumber.setBackground(horizontalCalendar.getNormalTextBackground());
