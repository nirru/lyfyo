...
public class HorizontalCalendar {
    ...
    private final RecyclerView.OnScrollListener onScrollListener = new RecyclerView.OnScrollListener() {
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                ...
                if (calendarListener != null && position != -1) {
    ...
    private Drawable selectedTextBackground,normalTextBackground;
    ...
    private HorizontalCalendar(Builder builder) {
        ...
        this.selectedTextBackground = builder.selectedTextBackground;
        this.normalTextBackground = builder.normalBackground;
    ...
    public void setSelectedTextBackground(Drawable selectedTextBackground) {
        this.selectedTextBackground = selectedTextBackground;
    }

    public Drawable getNormalTextBackground() {
        return normalTextBackground;
    }

    public void setNormalTextBackground(Drawable normalTextBackground) {
        this.normalTextBackground = normalTextBackground;
    }
    ...
    public static class Builder {
        ...
        int selectedDateBackground;Drawable selectedTextBackground,normalBackground;
        int selectorColor;
        ...
        public Builder selectedTextBackground(Drawable backgroundColor,Drawable normalBackground) {
            this.selectedTextBackground = backgroundColor;
